...
**Unique Units:**
Conquistador (Mounted Gunner), Missionary (Mounted Monk)
...
**Archery Range**
- Archer line: up to **Archer** (missing: Crossbowman, Arbalester)
...
**Monastery**
- Monk: up to **Monk**
- Missionary: up to **Missionary**

## Unique / special units
- Conquistador (70F 60G, 55 HP, 16 atk)
- Elite Conquistador (70F 60G, 70 HP, 19 atk)

## Missing technologies (generic techs this civ CANNOT research)
- University: Heated Shot, Siege Engineers, Treadmill Crane
- Economy: Crop Rotation, Gold Shaft Mining
