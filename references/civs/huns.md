...
- Knight line: up to **Paladin**

**Siege Workshop**
- Ram line: up to **Siege Ram**
- Mangonel line: up to **Mangonel** (missing: Onager)
...
- Elite Tarkan (60F 60G, 150 HP, 11 atk)
- Tarkan (60F 60G, 100 HP, 8 atk)

## Missing technologies (generic techs this civ CANNOT research)
- Blacksmith: Plate Mail Armor, Ring Archer Armor
- University: Architecture, Arrowslits, Fortified Wall, Guard Tower, Heated Shot, Keep, Siege Engineers, Treadmill Crane
- Barracks techs: Gambesons
- Monastery: Block Printing, Herbal Medicine, Redemption, Theocracy
- Economy: Crop Rotation, Stone Shaft Mining
- Dock techs: Shipwright
- Other: Hoardings, Siphons
